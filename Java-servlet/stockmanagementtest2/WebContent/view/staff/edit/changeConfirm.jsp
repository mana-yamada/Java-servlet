...
<%   if(errorMsg != null) { %>
	...
	<a href="/stockmanagementtest/StaffChange?value=reChangeInputByError"><button>入力画面へ戻る</button></a>
	<a href="/stockmanagementtest/StaffEdit?value=backFromConfirmByError"><button>職員情報編集画面へ戻る</button></a>
<% } else { %>
	<%-- エラーがなく問題ない場合 --%>
	<h3>職員情報 変更確認</h3>
...
<p><a href="/stockmanagementtest/StaffChange?value=changeAction"><button>変更</button></a></p>
