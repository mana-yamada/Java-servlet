	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException , IOException{
		...
		if(loginUser == null) {
			...
			if(parameter == null) {
				...
				if(strSheds == null) {
					//redirect
					response.sendRedirect("/stockmanagementtest/view/menu/menu.jsp");
				}
				...
				/*出庫の場合*/
					...
					/*問題ない場合*/
						...
						/*使用場所未選択の場合*/
						else if(strSpace.equals("nonSpace")) {
							//make errorMsg
				...
				/*入庫か出庫か未選択*/
				else if(strSheds.equals("nonsheds")) {
					//make errorMsg
